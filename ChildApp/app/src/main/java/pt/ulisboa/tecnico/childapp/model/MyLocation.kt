package pt.ulisboa.tecnico.childapp.model
...
data class MyLocation (val latitude: Double = 0.0, val longitude: Double = 0.0, var timestamp: String = "")

fun String.toLocation(): MyLocation? {
    ...
    val iv = jsonObject.get("iv").asString.toByteArray()
    ...
    return Gson().fromJson(this, MyLocation::class.java)
}

fun MyLocation.toSecureLocation(): String {
